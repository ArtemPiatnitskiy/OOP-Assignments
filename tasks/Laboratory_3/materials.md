...
- Когда объект инициализируется другим объектом того же класса, и исходный объект является *rvalue* (то есть, временным объектом, который скоро будет уничтожен). Это происходит, когда:
