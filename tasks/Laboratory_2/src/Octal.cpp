...
// Сложение
// Вариант 1 с использованием временного unique_ptr будет в materials_ptr.md (Файл materials_ptr.md будет находится в отдельном репозитории с матераилом лекци, так как он ещё полностью не готов. Там будет гораздо шире затронута тема указателей и умных указателей)
